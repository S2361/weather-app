...
function dataLoader(weatherURL, day, tempScale) {    
    ...
    .then(data => {
        ...
        const morningTemperature = data.forecast.forecastday[day].hour[7][tempScale]; //@7:00 am
        const afternoonTemperature = data.forecast.forecastday[day].hour[13][tempScale]; //@1:00 pm
        const eveningTemperature = data.forecast.forecastday[day].hour[18][tempScale]; //@6:00 pm
        const nightTemperature = data.forecast.forecastday[day].hour[22][tempScale]; //@10:00 pm
        ...
        const tomorrowMaxTemp = data.forecast.forecastday[1].day[`max${tempScale}`];
        const followingTomorrowMaxTemp = data.forecast.forecastday[2].day[`max${tempScale}`];
...
async function updateSuggestions(){ 
    ...
    possibleCities.forEach(result => {
        ...
        resultElement.addEventListener('click', function() {
            dataLoader(firstForecast + resultElement.textContent + secondForecast, 0, tempScale);
